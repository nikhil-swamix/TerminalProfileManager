...
(function (factory) {
  ...
  $.extend(Datepicker.prototype, {
    ...
    _getDate: function (inst) {
      var startDate =
        !inst.currentYear || (inst.input && inst.input.val() === '') ? null : this._daylightSavingAdjust(new Date(inst.currentYear, inst.currentMonth, inst.currentDay));
      return startDate;
    },
...
*/
  ...
  var widgetsSortable = $.widget('ui.sortable', $.ui.mouse, {
    ...
    _createHelper: function (event) {
      var o = this.options,
        helper =
          typeof o.helper === 'function' ? $(o.helper.apply(this.element[0], [event, this.currentItem])) : o.helper === 'clone' ? this.currentItem.clone() : this.currentItem;
